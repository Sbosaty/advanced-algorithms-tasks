...
using namespace std;
ofstream graphs_file("graphs_sort.csv");
...
int bubble_sort_count(vector<int>& arr, int &time) {
    int count = 0;
...
int selection_sort_count(vector<int>& arr, int &time) {
    int count = 0;
    auto start = chrono::high_resolution_clock::now();
    for (int i = 0; i < arr.size() - 1; i++) {
        int min_idx = i;
...
int insertion_sort_count(vector<int>& arr, int &time) {
    int count = 0;
    auto start = chrono::high_resolution_clock::now();
...
int heap_sort_count(vector<int>& arr, int &time) {
    int count = 0;
    auto start = chrono::high_resolution_clock::now();
